# Contributing to socket.io-streamify
...
Fork the project [on GitHub](https://github.com/geut/socket.io-streamify) and check out your copy locally.

```bash
$ git clone git@github.com:username/socket.io-streamify.git
$ cd socket.io-streamify
$ npm install
$ git remote add upstream git://github.com/geut/socket.io-streamify.git
```
